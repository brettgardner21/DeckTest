...
@implementation DeckTestAppDelegate
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    [WorkoutCard registerSubclass];
    
    [Parse setApplicationId:@"h4t4vpIJakzrHVXwSvvfBwwTJL5ZCbGD6cTzWhKo"
                  clientKey:@"kxWlTSWMuKhIG0ijgRn5Dt2evR2mFjKNXIiUmH5G"];
